---
title: "Revisiting the garden SAR"
output: 
    github_document:
      toc: true
---
...
Code all taken from the code for the Why Theory lecture, removing saving plots and a couple of dependencies (upscale, socorro).
